...
class ValidadorRegistro {
    ...
    public function __construct($nombre, $email, $clave1, $clave2, $conexion) {
        ...
        $this->error_clave1 = $this->validar_calve1($clave1);
    ...
    private function validar_calve1($clave1) {
    ...
    private function validar_clave2($clave1, $clave2) {
        ...
        if ($clave1 !== $clave2) {
            return "Ambas contraseña sdeben coincidir";
        }
        return "";
    }
    ...
    public function mostrar_error_nombre() {
        if ($this->error_nombre !== "") {
            echo $this->aviso_inico . $this->error_nombre . $this->aviso_cierre;
        }
    }
    ...
    public function mostrar_error_email() {
        if ($this->error_email !== "") {
            echo $this->aviso_inico . $this->error_email . $this->aviso_cierre;
        }
    }

    public function mostrar_error_clave1() {
        if ($this->error_clave1 !== "") {
            echo $this->aviso_inico . $this->error_clave1 . $this->aviso_cierre;
        }
    }

    public function mostrar_error_clave2() {
        if ($this->error_clave2 !== "") {
            echo $this->aviso_inico . $this->error_clave2 . $this->aviso_cierre;
        }
    }
